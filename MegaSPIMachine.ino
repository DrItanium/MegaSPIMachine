...
void setup() {
    ...
    pinMode(IOExpander0_CS, OUTPUT);
    digitalWrite(IOExpander0_CS, HIGH);
    pinMode(IOExpander1_CS, OUTPUT);
    digitalWrite(IOExpander1_CS, HIGH);
    tft.begin();
